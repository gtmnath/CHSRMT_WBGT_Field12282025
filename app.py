...
ss = st.session_state
# ================================
# SESSION STATE BOOTSTRAP (CRITICAL)
# ================================
if "units" not in ss:
    ss["units"] = "metric"   # display units only
...
if not ss["landing_open"]:
    ...
    <div class="welcome-box">
        ...
        <p>Field-ready Heat Stress Risk  assessment with penalties, OSHA/NIOSH thresholds,
        hydration and acclimatization guidance.</p>
        <p><b>Workflow:</b> Input/Weather → Baseline → Penalties → Classification → Action → Logging</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    • Gives Supervisor/Team Leader guidance  
    """)
...
# --- RH ---
with col2:
    ss["rh_pct"] = st.number_input("RH (%)", value=float(ss["rh_pct"]), min_value=0.0, max_value=100.0)
...
st.caption("If you entered weather manually, please adjust Globe Temperature to match sun/radiant exposure.")
...
if wbgt_eff is None:
    ...
    # ==================================================================
    # CHSI — intentionally suppressed for public release
    # ==================================================================
    if False:   # ← CHSI disabled (kept for future use)
...
# ==============================================================
# BLOCK 9 — APPENDIX & FIELD GUIDANCE (MASTER COLLAPSIBLE)
# ==============================================================
...
<div class="footer">
© 2025 Dr Gummanur T. Manjunath — CHSRMT Field Heat-Stress Decision Support Tool. All rights reserved. &nbsp; | &nbsp; Build: v2.0-WBGT-Field
</div>
""", unsafe_allow_html=True)
